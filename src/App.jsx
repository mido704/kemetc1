...
export default function App() {
  ...
  const [page, setPage] = useState(()=>{ const p = window.location.pathname; if (p==='/eclipse') return 'eclipse'; if (p==='/store') return 'store'; if (p==='/medical') return 'medical'; return 'feed'; });
