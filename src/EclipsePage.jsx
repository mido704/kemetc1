    ...
    <div className="ecl">
      ...
      <div className='ecl-sec'>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(220px,1fr))',gap:14,padding:'0 4px'}}>
          {tours.map(tour=>(
            <div key={tour.id} style={{background:'var(--bc,#0d0a02)',border:'1px solid rgba(201,168,76,0.25)',borderRadius:12,overflow:'hidden',cursor:'pointer'}} onClick={()=>onBook&&onBook()}>
